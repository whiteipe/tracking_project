...
switch (true) {
    ...
    case ($source === 'taboola' || $medium === 'taboola'):
        ...
        break;
    default:
        $redtrack = "68c42dc4b73f84afb67932a3";
        $lp1 = "VMS-A6-Bacteria-Ger-09-12-25-facebook";
}


$htmlFile = 'index.html';
$defaultHeadline = "Top-Arzt Warnt: Haben Sie Mäuse? Prüfen Sie Ihren Küchenschrank Nach Dieser 1 Zutat (Sie Haben Sie Vielleicht Bereits)";
