...
// Keep only this LPV (no split)
$redtrack = "68a58137f6c843440f034a97";
$lp1 = "VMS-Mice-Bacteria-A8-08-29-25-News";
$htmlFile = 'index.html';
...
ob_start();
echo '<base href="/vms/mice-bacteria/a8/">';
include($_SERVER['DOCUMENT_ROOT'] . '/vms/mice-bacteria/a8/index.html');
