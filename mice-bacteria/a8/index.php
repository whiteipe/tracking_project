...
// Step 1: Get or assign variant (75 / 5 / 10 / 5 / 5)
...
if ($variant === 1) {
    // Main (75%)
    $redtrack = "6895ce834ce36cfd08b370ac";
    $htmlFile = 'index.html';
    $lp1 = "VMS-Bacteria-A8-08-08-25-facebook";
    $defaultHeadline = "Don't Try Anything Else for Mice Until You See This";

} elseif ($variant === 2) {
    // 5%
    $redtrack = "6895ce834ce36cfd08b370ac";
    $lp1 = "VMS-Bacteria-A6-08-22-25-News-GOOGLE";
    $htmlFile = 'mice-bacteria-a6/index.php';
    $defaultHeadline = "Top Dr. Warns: Got Mice? Check Your Cupboard for This 1 Ingredient (You May Already Have It)’";

} elseif ($variant === 3) {
    // 10%
    $redtrack = "6895ce834ce36cfd08b370ac";
    $lp1 = "VMS-Bacteria-A8-08-08-25-GOOGLE";
    $htmlFile = 'mice-bacteria-a8/index.php';
    $defaultHeadline = "Don't Try Anything Else for Mice Until You See This’";

} elseif ($variant === 4) {
    // 5%
    $redtrack = "6895ce834ce36cfd08b370ac";
    $lp1 = "VMS-Mice-Personal-Story-A5-08-27-25-News-GOOGLE";
    $htmlFile = 'mice-firstperson-personal-story/index.php';
    $defaultHeadline = "This 30-Second Hack Got Rid Of My Mice Problem, After 4 Months of Torture";

} else {
    // 5%
    $redtrack = "6895ce834ce36cfd08b370ac";
    $lp1 = "VMS-A6-Property-Damage-08-08-25-GOOGLE";
    $htmlFile = 'mice-propertydamage-a6/index.php';
    $defaultHeadline = "Top Dr. Warns: Got Mice? Check Your Cupboard for This 1 Ingredient (You May Already Have It)";
}

switch (true) {
    case ($source === 'newsbreak' || $medium === 'newsbreak'):
        $redtrack = "68a58137f6c843440f034a97";
        $lp1 = "VMS-Mice-Bacteria-A8-08-20-25-News";
        $htmlFile = 'index.html';
        $defaultHeadline = "Don't Try Anything Else for Mice Until You See This";
        break;
    case ($source === 'mediago' || $medium === 'mediago'):
        $redtrack = "68a58235f6c843440f036837";
        $lp1 = "VMS-Mice-Bacteria-A8-08-20-25-MediaGo";
        $htmlFile = 'index.html';
        $defaultHeadline = "Don't Try Anything Else for Mice Until You See This";
        break;
    case ($source === 'taboola' || $medium === 'taboola'):
        $redtrack = "68b1ba3d3b7e38bea4bef1b9";
        $lp1 = "VMS-Mice-Bacteria-A8-08-20-25-Taboola";
        $htmlFile = 'index.html';
        $defaultHeadline = "Don't Try Anything Else for Mice Until You See This";
        break;
}

// (Optional) then render:
// include($htmlFile);
